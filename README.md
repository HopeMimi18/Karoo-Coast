...
Selected stops now expose a tourism-discovery panel. Instead of ending at “you reached Kimberley”, the product can continue into “what should I discover here?”. The current data is intentionally labelled as a prototype tourism layer; production facilities, opening hours and booking links should come from verified operator and tourism-partner feeds.
